...
function mig5_theme_settings($saved_settings) {

  $settings = theme_get_settings('mig5_theme');
  ...
  $form['layout_1']['layout_1_min_width'] = array(
    ...
    '#options' => mig5_theme_generate_array(200, 1400, 10, 'px'),
  );
...
function mig5_theme_generate_array($min, $max, $increment, $postfix, $unlimited = NULL) {
  $array = array();
  if ($unlimited == 'first') {
